...
func TestNewRedisMQFlow_PoolRequiredAndValidation(t *testing.T) {
	...
	cfg := PubSubConfig{
		URL:    url,
		Queues: []QueueConfig{{QueueName: "test-queue", InferenceObjective: "obj", IGWBaseURL: "http://gw"}},
	}
	cfg.ApplyDefaults()
	...
	cfg = PubSubConfig{
		URL:    url,
		Queues: []QueueConfig{{QueueName: "test-queue", WorkerPoolID: "custom-pool", InferenceObjective: "obj", IGWBaseURL: "http://gw"}},
	}
	cfg.ApplyDefaults()
	_, err = NewRedisMQFlow(cfg, []pipeline.WorkerPoolConfig{{ID: "default", Workers: 1}})
	if err == nil {
	...
	cfg = PubSubConfig{
		URL:    url,
		Queues: []QueueConfig{{QueueName: "test-queue", WorkerPoolID: "non-existent", InferenceObjective: "obj", IGWBaseURL: "http://gw"}},
	}
	cfg.ApplyDefaults()
	_, err = NewRedisMQFlow(cfg, []pipeline.WorkerPoolConfig{{ID: "test-pool", Workers: 1}})
	if err == nil {
	...
	cfg = PubSubConfig{
		URL:    url,
		Queues: []QueueConfig{{QueueName: "test-queue", WorkerPoolID: "test-pool", InferenceObjective: "obj"}},
	}
	cfg.ApplyDefaults()
	...
	cfg = PubSubConfig{
		URL:    url,
		Queues: []QueueConfig{{QueueName: "test-queue", WorkerPoolID: "test-pool", InferenceObjective: "obj", IGWBaseURL: "http://gw"}},
	}
	cfg.ApplyDefaults()
	_, err = NewRedisMQFlow(cfg, []pipeline.WorkerPoolConfig{{ID: "test-pool", Workers: 1}})
	if err != nil {
